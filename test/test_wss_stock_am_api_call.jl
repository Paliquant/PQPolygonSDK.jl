begin
    ...
    endpoint_options["event_type"] = "AM"
    ...
    endpoint_model = model(PolygonAggregatesPerMinuteStocksWebSocketsEndpointModel, user_model, endpoint_options)
    ...
    (status_log, data_log) = build_websocket_response_framework(PolygonAggregatesPerMinuteStocksWebSocketsEndpointModel)
...
@testset "test api call no concurrent connection" begin
    ...
    "status, success, subscribed to: AM.AAPL\n"*
    "status, success, subscribed to: AM.TSLA\n"*
    "status, success, subscribed to: AM.MSFT\n"*
    "status, success, subscribed to: AM.AMZN\n"*
    "status, success, subscribed to: AM.META\n"*
    "status, success, subscribed to: AM.AMD\n"*
    "status, success, subscribed to: AM.GOOG\n"*
    "status, success, subscribed to: AM.HOOD\n"*
    "status, success, subscribed to: AM.NFLX\n"*
    "status, success, subscribed to: AM.NVDA\n"*
    "status, success, subscribed to: AM.PLTR\n"
